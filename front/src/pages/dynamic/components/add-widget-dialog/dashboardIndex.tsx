...
import { DashboardStep1 } from "../step1/dashboardIndex";


const AddWidgetDashboardDialog = () => {
  const { widgetId, addWidget, setWidgetId } = useGridStore();
  ...
  return (
    ...
    >
      ...
      <DialogContent
        className={cn("max-w-md max-h-screen overflow-y-auto z-[99999]", {
...
export default AddWidgetDashboardDialog;
