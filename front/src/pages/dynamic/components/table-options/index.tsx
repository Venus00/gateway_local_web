...
import { ChartTelemetry, LineChartWidgetData, TableWidgetData } from "@/utils";
...
export default function TableOptions() {
  ...
  const { telemetries = [] } = data.attributes as TableWidgetData;
          ...
          <Table>
            ...
            <TableHeader>
              <TableRow>
                ...
                {}
                {/*<TableHead>Telemetrie</TableHead>
            ...
            <TableBody>
              <TableRow>
                {telemetries.length > 0 && (
                  <>
                    <TableCell className="text-left text-black dark:text-white">
                      {addHours(now, 0).toLocaleDateString("en-US", {
                        hour: "2-digit",
                        minute: "2-digit",
                        second: "2-digit",
                      })}
