...
function MachineTypeView({ machines, onDelete }: PropsTaype) {
  ...
  return (
    <>
      <div className="  dark:bg-neutral-800 py-8 px-4 sm:px-6 lg:px-8">
        ...
        {view === "table" && (
          <div className="">
            <MachineTypeTable machines={machines} onDelete={onDelete} />
          </div>
        )}
        {/* Card view */}
        {view === "card" && (
                          ...
                          <div className="min-w-0">
                            <div className="flex flex-wrap gap-1.5">
                              {visibleOutputTags.length > 0 ? (
                                ...
                                <span className="inline-flex items-center bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 text-red-800 dark:text-red-200 text-xs px-2 py-1 rounded-md">
                                  N/A
                                </span>
                              )}
                            </div>
