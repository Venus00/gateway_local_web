...
// async function sendFlowCreationToServer(flowData) {
//     try {
//         const response = await fetch('https://localhost/api/flows', {
//             method: 'POST',
//             headers: {
...
//         if (!response.ok) {
//             console.error('Erreur lors de l\'envoi au serveur:', response.statusText);
//         }
//     } catch (error) {
