...
ALTER TABLE "connection_inputs" ADD COLUMN "machine_id" serial NOT NULL;--> statement-breakpoint
ALTER TABLE "connection_outputs" ADD COLUMN "name" text;--> statement-breakpoint
...
END $$;
--> statement-breakpoint
ALTER TABLE "connection_inputs" DROP COLUMN IF EXISTS "connection_id";--> statement-breakpoint
ALTER TABLE "connection_outputs" DROP COLUMN IF EXISTS "connection_id";